...
//    }
    ...
    fun noText() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = spase
        device.findObject(By.res(packageName, "buttonChange")).click()
    ...
    fun newActivity() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = helloWOrld
        device.findObject(By.res(packageName, "buttonActivity")).click()
        device.wait(
        Until.findObject(By.res("com.example.app:id/secondTextView")),
        TIMEOUT)
